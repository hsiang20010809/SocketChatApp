...
public class Client1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnConnect.setOnClickListener(v -> {
            if (isValidClientName()) {
                ...
                Toast.makeText(Client1Activity.this, "Please enter a valid name", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void connectToServer() {
        ...
        try {
            ...
            Toast.makeText(Client1Activity.this, "Invalid server port", Toast.LENGTH_SHORT).show();
            return;
        }
